...
const fermenterIcon = (props) => {
    return  (  
    <svg fill={fillColor[props.componentStatus]} id="fermentationVisuals" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" viewBox="0 0 432 288"  xmlSpace="preserve">
